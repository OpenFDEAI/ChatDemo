...
export default function Workbench({
  ...
  // Deep-link the persona (?role=agent) for projector jumps and screenshot checks.
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl space-y-6 px-6 py-6">
        <Dashboard tickets={visible} terms={theme.terms} anchor={anchor} scopeLabel={scopeLabel} />
